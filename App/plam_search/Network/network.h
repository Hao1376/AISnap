...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "node_033_palm_detection_full_quant_pc_ff_od"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (442368)
...
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (8064)
// Output buffer 2 -- Transpose_338_out_0
#define LL_ATON_NETWORK_OUT_2_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_2_SIZE_BYTES  (145152)
